...
public class RpcFramework {
	...
	public static void export(final Object service, final Class interfaceClazz, int port)
			throws Exception {
		if (service == null) {
	...
	public static <T> T refer(final Class<T> interfaceClass, final String host, final int port)
		...
		if (!interfaceClass.isInterface()) {
			throw new IllegalAccessException(interfaceClass.getName()
					+ " must be interface");
		}
